...
The second option, which enable the user to edit and modify the code, is to use a Python environment. We recommend Spyder, see \ref{installationInstructions}.
