...
For simulating the system we are using the multibody dynamics code Exudyn \cite{Exudyn2023}, see also the GitHub repository of Exudyn\footnote{https://github.com/jgerstmayr/EXUDYN}.
%
